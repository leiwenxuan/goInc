...
func ginConsulCheck9529(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, "consulCheck")
}

func ginRegisterServer9529(serverId string, port int, checkPort int) {
	...
	http.HandleFunc("/check", ginConsulCheck9529)
...
func main() {
	...
	ginRegisterServer9529(fmt.Sprintf("%d", count), count, count)
