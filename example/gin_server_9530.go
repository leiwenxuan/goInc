...
func ginConsulCheck9530(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, "consulCheck")
}

func ginRegisterServer9530(serverId string, port int, checkPort int) {
	...
	http.HandleFunc("/check", ginConsulCheck9530)
...
func main() {
	...
	ginRegisterServer9530(fmt.Sprintf("%d", count), count, count)
