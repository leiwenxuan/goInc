...
func ginConsulCheck9531(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, "consulCheck")
}

func ginRegisterServer9531(serverId string, port int, checkPort int) {
	...
	http.HandleFunc("/check", ginConsulCheck9531)
...
func main() {
	...
	ginRegisterServer9531(fmt.Sprintf("%d", count), count, count)
